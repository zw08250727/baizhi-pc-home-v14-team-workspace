window.AppsDataUI = (() => {
  ...
  function task(run) {
    ...
    const query=new URLSearchParams({edition:personal()?'personal':'enterprise',workspace:team()?'team':'',agent:run.agent,run:run.id,app:state.app||'',scope:state.scope,from:'apps-history'});
