window.AppsDataUI = (() => {
  ...
  function renderDetail() {
    ...
    if(state.tab==='data'){
      ...
      const footer=G.footer(rows.length),slice=rows.slice((state.page-1)*7,state.page*7),tools=G.toolbar(table);
